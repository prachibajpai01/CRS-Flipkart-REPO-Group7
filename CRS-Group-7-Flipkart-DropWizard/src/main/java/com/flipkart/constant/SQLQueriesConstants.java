...
public class SQLQueriesConstants {
    ...
    public static final String VIEW_PROFESSOR = "SELECT * FROM professor, user WHERE professor.proffId = user.userName";
    ...
    public static final String VIEW_PENDING_ADMISSIONS = "SELECT student.userId, user.userName, user.password, student.branch FROM student, user WHERE student.userId = user.userName AND approved = 0";
    ...
    public static final String GET_REGISTRATION_STATUS="select approved from student where userId = ?";

    public static final String CHECK_COURSE_AVAILABILITY=" select courseCode from registered_courses where studentId = ? ";
